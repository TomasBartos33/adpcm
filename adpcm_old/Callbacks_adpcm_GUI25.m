function Callbacks_adpcm_GUI25(f,C,start_path)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Callback for button1 -- Get Speech Files Directory
 function button1Callback(h,eventdata)
     ...
     A=char(strcat((directory_name),[chr,'*.wav']));
...
% determine region of file for adpcm processing; 
% first reset graphic Panel 3 and plot full waveform
     reset(graphicPanel3);
     axes(graphicPanel3);
     l=length(curr_file);
     index=(0:l-1);
