...
% % on the directory chain; as follows:
     dir_cur=pwd;           % current Matlab exercise directory path 
     s=regexp(dir_cur,chr); % find the last '\' for the current directory
     s1=s(length(s));       % find last '\' character - upper level directory
